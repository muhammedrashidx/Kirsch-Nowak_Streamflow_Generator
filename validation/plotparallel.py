# -*- coding: utf-8 -*-
"""
Created on Sat May 14 02:39:43 2022
...
# -*- coding: utf-8 -*-
"""
Created on Tue May 10 09:56:04 2022
...
#ynames =['NOISE', 'WEMP', 'DOC', 'ROUGH', 'WFUEL']
#all_soln = np.loadtxt(open("data_tradeoff.csv"), delimiter=",")
ys =iris.data
ymins = ys.min(axis=0)
ymaxs = ys.max(axis=0)
dys = ymaxs - ymins
...
plt.tight_layout()
plt.show()
ax.set_ylabel("$\leftarrow$ Direction of preference", fontsize=12)